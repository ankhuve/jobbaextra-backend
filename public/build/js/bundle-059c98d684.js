...
var _chart = require("../../../node_modules/chart.js");
            ...
            var myChart = new _chart2.default(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: counts,
                        backgroundColor: ['rgba(27, 128, 158, 0.5)'],
                        borderColor: ['rgba(27, 128, 158, 1)'],
...
if (usersCtx) {
    $.ajax({
        ...
        success: function success(data) {
            ...
            var myChart = new _chart2.default(usersCtx, {
                type: 'line',
                data: {
                    labels: dates,
                    datasets: [{
                        label: 'Nya användare',
                        data: counts,
                        backgroundColor: ['rgba(72, 180, 66, 0.5)'],
                        borderColor: ['rgba(57, 132, 51, 1)'],
...
},{"../../../node_modules/chart.js":1}],52:[function(require,module,exports){
"use strict";

...
@section('dashboard')
    ...
    <div class="bs-callout bs-callout-info">
        <p>
            Här listas alla block på sidan som för tillfället är editerbara. Vill du ändra något är det bara att ändra
            texterna och trycka på spara.
            <br><br>
            Glöm inte att titta på <a
                    href="{{ config('app.url-front') }}">{{ env('APP_NAME', 'Jobbförmedlaren.se') }}</a> så att allt ser
            bra ut efter att du har sparat!
        </p>
    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group error bs-callout bs-callout-danger">
                                Det uppstod ett fel. <a href="{{ \Illuminate\Support\Facades\URL::current() }}">Uppdatera
                                    sidan</a> och försök igen.
                                <hr>
